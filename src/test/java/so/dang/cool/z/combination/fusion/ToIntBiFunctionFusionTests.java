...
public class ToIntBiFunctionFusionTests {
    ...
    void toIntBifn_to_intFn() {
        assertEquals(
            "3",
            Z.fuse(addStringsAsInt, intToString).apply("1").apply("2")
        );
    }
    ...
    void toIntBifn_to_intFn_deep() {
        assertEquals(
            "3",
            Z.with(addStringsAsInt).fuse(intToString).apply("1").apply("2")
        );
    }
    ...
    void toIntBifn_to_intToDbl() {
        assertEquals(
            3.0,
            Z.fuse(addStringsAsInt, intToDouble).apply("1").applyAsDouble("2")
        );
    }
    ...
    void toIntBifn_to_dblToLong() {
        assertEquals(
            9L,
            Z.fuse(addStringsAsInt, intToLong).apply("4").applyAsLong("5")
        );
    }
    ...
    void toIntBifn_to_intUnop() {
        assertEquals(
            6,
            Z.fuse(addStringsAsInt, addTwoToInt).apply("1").applyAsInt("3")
        );
    }
    ...
    void toIntBifn_to_intBiop() {
        assertEquals(
            6,
            Z.fuse(addStringsAsInt, addInts).apply("1").apply("2").applyAsInt(3)
        );
    }
}
