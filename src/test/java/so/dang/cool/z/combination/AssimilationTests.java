...
public class AssimilationTests {
    ...
    public void assimilate4_test() {
        assertEquals(
            "abcd",
            Z.assimilate4(curriedConcat4).apply("a", "b", "c", "d")
        );
    }
    ...
    public void assimilate5_test() {
        assertEquals(
            "abcde",
            Z.assimilate5(curriedConcat5).apply("a", "b", "c", "d", "e")
        );
    }
    ...
    public void assimilate6_test() {
        assertEquals(
            "abcdef",
            Z.assimilate6(curriedConcat6).apply("a", "b", "c", "d", "e", "f")
        );
    }
    ...
    public void assimilate11_test() {
        assertEquals(
            "abcdefghijk",
            Z
                .assimilate11(curriedConcat11)
                .apply("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k")
        );
    }
