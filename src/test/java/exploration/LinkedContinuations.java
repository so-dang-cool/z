...
public class LinkedContinuations {
    ...
    @Test
    void test1() {
        Function<String, Function<String, String>> comp = X
            .of(concat)
            .resolve();
    ...
    void test2() {
        ...
        Function<Function<String, Function<String, String>>, Function<String, Function<String, Function<String, String>>>> bridge = fn ->
            a -> b -> fn.apply(concat.apply(a, b));

        Function<String, Function<String, String>> next = a ->
            c -> concat.apply(a, c);

        Function<String, Function<String, Function<String, String>>> comp = bridge.apply(
            next
        );
    ...
    void test3() {
        ...
        assertEquals(
            "hello",
            bridgedfn.apply(/*next*/trim).apply(" hel").apply("lo ")
        );
        ...
        Function<String, Function<String, String>> curriedfn = a ->
            b -> concat.apply(a, b);

        assertEquals(
            "hello",
            bridgedfn2
                .apply(/*next*/curriedfn)
                .apply("h")
                .apply("e")
                .apply("llo")
        );
...
abstract class X {
    ...
    static class Start<A, B, C, Next> extends X {
        ...
        <D, E, Nexter> Continue<Function<Function<C, Next>, Function<A, Function<B, Next>>>, C, D, E, Nexter> and(
    ...
    static <A, B, C, Next> Start<A, B, C, Next> of(
        BiFunction<A, B, C> initial
    ) {
