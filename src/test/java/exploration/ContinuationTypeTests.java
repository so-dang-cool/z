...
public class ContinuationTypeTests {
    ...
    @Test
    void explore1() {
        Function<String, Function<String, String>> concatter = a ->
            b -> concat.apply(a, b);
    ...
    @Test
    void explore2() {
        Function<Function<String, String>, Function<String, Function<String, String>>> concatter =
            null;
        Function<String, Function<String, String>> concatter2 = a ->
            b -> concat.apply(a, b);
    ...
    @Test
    void explore3() {
        Function<String, Function<String, String>> con_1 = a ->
            b -> concat.apply(a, b);
        assertEquals("ab", con_1.apply("a").apply("b"));

        Function<String, Function<String, Supplier<String>>> con_2 = a ->
            b -> () -> concat.apply(a, b);
        assertEquals("ab", con_2.apply("a").apply("b").get());

        Function<String, Supplier<Function<String, String>>> con_3 = a ->
            () -> b -> concat.apply(a, b);
        assertEquals("ab", con_3.apply("a").get().apply("b"));

        Function<String, Function<Function<String, String>, Function<String, String>>> con_4 = a ->
            fn -> b -> fn.apply(concat.apply(a, b));
        assertEquals("AB", con_4.apply("a").apply(toUpper).apply("b"));

        Function<Function<String, String>, Function<String, Function<String, String>>> con_5 = fn ->
            a -> b -> fn.apply(concat.apply(a, b));
        assertEquals("AB", con_5.apply(toUpper).apply("a").apply("b"));

        Function<Function<String, Integer>, Function<String, Function<String, Integer>>> con_5a = fn ->
            a -> b -> fn.apply(concat.apply(a, b));
        assertEquals(2, con_5a.apply(String::length).apply("a").apply("b"));

        Function<Function<String, Function<String, String>>, Function<String, Function<String, Function<String, String>>>> con_5b = fn ->
            a -> b -> fn.apply(concat.apply(a, b));
        assertEquals(
            "abc",
            con_5b.apply(Z.split(concat)).apply("a").apply("b").apply("c")
        );

        Function<String, Function<String, Function<Function<String, String>, String>>> con_6 = a ->
            b -> fn -> fn.apply(concat.apply(a, b));
